...
\label{sec:orgcf8c830}
\subsection{Project aims}
\label{sec:orgfdfe227}
...
\label{sec:orgffb358e}
\subsection{Modelling, textures, and shading}
\label{sec:org26cd213}
The scaling of the models was deliberately chosen to be unrealistic in order to
simplify the translation from position with the back to front end (See \hyperref[sec:orgecee11b]{Python
side - Array index to world space})
\subsubsection{Nodes}
\label{sec:org5a3e74c}
...
the planned indirect lighting (See \hyperref[sec:org252d4e4]{Lighting - Disco Ball}).
...
\section{Results}
\label{sec:orgf962ebf}
\section{Evaluation}
\label{sec:org94c8969}

\newpage
\section{Appendix}
\label{sec:org34bbf94}
\begin{figure}[htbp]
\centering
